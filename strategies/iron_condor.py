...
class IronCondorStrategy(BaseStrategy):
    ...
    def __init__(
        ...
        *,
        ...
        short_strike_delta_max: float = 0.34,
        spread_width: int = 100,
        profit_target_pct: float = 60.0,
        stop_loss_multiplier: float = 1.0,
        entry_days_before_expiry_min: int = 3,
        entry_days_before_expiry_max: int = 12,
        max_total_capital: float = 100_000.0,
        max_daily_loss: float = 20_000.0,
        max_weekly_loss: float = 45_000.0,
        max_loss_pct_of_capital: float = 20.0,
        max_consecutive_losses: int = 4,
        min_premium_per_unit: float = 5.0,
        max_capital_per_position: float = 22_000.0,
